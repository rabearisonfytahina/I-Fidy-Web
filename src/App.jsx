...
function App() {
  ...
  useEffect(() => {
    ...
    if (menuTrigger) menuTrigger.addEventListener("click", handleMenuClick);

    return () => {
      if (menuTrigger) menuTrigger.removeEventListener("click", handleMenuClick);
    };
  }, []);
